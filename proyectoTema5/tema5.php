...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <ul class="list-group">
                <div >
                    <p class="parrafo1">1. Mostrar el contenido de las variables superglobales y phpinfo().</p><a class="text-decoration-none" href="codigoPHP/ejercicio0.php"><p class="mostar">Ejecutar</p ></a>
                    <hr>
                </div>
                <div >
                    <p>1. Desarrollo de un control de acceso con identificación del usuario basado en la función header().</p><a class="text-decoration-none" href="mostrarcodigo/muestraEjercicio01b.php"><p class="mostar">Ejecutar</p ></a>
                    <hr>
                </div>
                <div >
