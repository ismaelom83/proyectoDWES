...
<!DOCTYPE html>
<!--
                       <---------------------------REHABILITACION REGISTROS-------------------------------------------------->

<html>
    <head>
        <title>Rehabilitar registros</title>
        <meta charset="UTF-8">
    ...
    <body>   
        <form action="" method="post">
            <h2>¿Deseas rehabilitar este registro?</h2>
            <br>
        ...
        try {
            ...
            //y si no no lo borra.
             if(isset($_POST['si']) && $_POST['si'] == 'SI') {
                $sql = "UPDATE Departamento SET FechaBaja=NULL  WHERE CodDepartamento LIKE '" . $_GET['codigo'] . "' ";           
                $resultadoConsulta = $miDB2->query($sql);
                echo '<br>';
                echo '<h2>Registro Rehabilitado</h2>';
                echo '<br>';
