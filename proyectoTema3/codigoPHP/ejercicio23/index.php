        ...
        if ($entradaOK) {//si la variable entradaOK es verdadera mostramos los datos del formulario. 
            ...
            <div class="wrap">
                <form action='<?php echo $_SERVER['PHP_SELF']; ?>' method="post">
                    <input type="text" name="numero1" id="numero1" class="form-control" placeholder="Introduce numero1:" value="">
                    <?php if ($errores['numero1'] != NULL) { ?>
                        <div>
                            <?php echo $errores['numero1']; //mensaje de error que tiene el array aErrores    ?>
                        </div>   
                    <?php } ?> 
                    <input type="text" name="numero2" id="numero2" class="form-control" placeholder="Introduce numero2:" value="">
